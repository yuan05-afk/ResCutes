...
import { NotificationSlotProvider } from "@/components/notifications/notification-slot-context";
...
export function AppShell({
  ...
  return (
    <NavigationPendingProvider>
      <NotificationSlotProvider slot={notificationSlot}>
        <AppRoutePrefetcher />
        <div className="flex h-[100dvh] bg-bone lg:overflow-hidden">
          ...
          <div className="flex min-h-0 min-w-0 flex-1 flex-col">
            {/* Mobile-only chrome. Desktop bell lives in DashboardHeader. */}
            <WebMobileHeader
              isAdministrator={isAdmin}
