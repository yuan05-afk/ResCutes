...
const SEED_CASES: DemoCase[] = [
  ...
  },
  {
    ...
    verifiedById: DEMO_IDS.users.sarah,
    assignedShelterId: DEMO_IDS.shelters.cara,
    animalId: "animal-001",
  ...
  },
  {
    ...
    verifiedById: DEMO_IDS.users.sarah,
    assignedShelterId: DEMO_IDS.shelters.helpMas,
...
const SEED_ANIMALS: DemoAnimal[] = [
  ...
  },
  {
    ...
    shelterId: DEMO_IDS.shelters.helpMas,
...
const SEED_STATUS_HISTORY: DemoStatusHistory[] = [
  ...
  },
  {
    ...
    changedById: DEMO_IDS.users.sarah,
    note: "Handoff confirmed at PAWS Animal Rehabilitation Center (PARC)",
    createdAt: hoursAgo(4),
  },
];
...
const SEED_NOTIFICATIONS: DemoNotification[] = [
  {
    ...
    message:
      "Your report for Luna has been updated. Luna has been safely handed off to PAWS Animal Rehabilitation Center (PARC) and is receiving care.",
    caseId: DEMO_IDS.luna.case,
    read: false,
    createdAt: hoursAgo(4),
  },
